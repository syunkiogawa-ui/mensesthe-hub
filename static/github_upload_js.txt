...
function showTherapistDetail(therapistId) {
    ...
    // モーダル内容の更新
    document.getElementById('modalTherapistName').textContent = displayName;
    document.getElementById('detailTherapistName').textContent = displayName;
    document.getElementById('detailTherapistAge').textContent = therapist.age_group; // 年代のみ表示
